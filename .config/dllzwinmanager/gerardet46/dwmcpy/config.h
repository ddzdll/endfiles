...
static int smartborders            = 0;   /* 1 means no outer gap when there is only one window */
...
static int user_bh                 = 26;  /* 0 means that dwm will calculate bar height, >= 1 means dwm will user_bh as bar height */
 ...
 */
    ...
    { "firefox*",        NULL,       "Firefox",              1 << 1,       0,           0,        -1 },
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_F2,     spawn,          SHCMD("dmenu_run") },
    { MODKEY,                       XK_F5,     xrdb,           {0}},
    { MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
    { MODKEY,                       XK_b,      togglebar,      {0} },
    STACKKEYS(MODKEY,                          focus)   //focus and push main window
    ...
    { MODKEY,                       XK_space,  zoom,           {0} },   //set default window
