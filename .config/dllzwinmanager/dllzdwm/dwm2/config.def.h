...
static const char *fonts[]               = { "Ubuntu:size=12", "Font Awesome:size=13", "Noto Color Emoji:pixelsize=13:antialias=true:autohint=true" };
...
static char tagsselbgcolor[]             = "#20242c";
